...
// the upstream READMEs inside each repo directory. The same reasoning
// applies to concepticon/ and parallel-classics/: their README.md is this
// repo's own catalog note (schema, provenance, what was rejected and why),
// not a document collected from a source.
const NOT_A_DOCUMENT = /(^|\/)(ATTRIBUTION\.md|PROVENANCE\.md|VETTING\.md|[a-z0-9-]*manifest\.json)$|^09-source-code\/README\.md$|^11-multi-language\/(concepticon|parallel-classics)\/README\.md$/i;
